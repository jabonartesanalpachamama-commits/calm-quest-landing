...
const PROGRAMS = [
  ...
  },
  {
    ...
    features: ["Virtual", "Comunidad de apoyo", "Sabiduría ancestral & corporal"],
  ...
  },
  {
    ...
    desc: "Clases privadas y programas adaptados a tu momento vital, tu historia y tu camino personal. Espacio diseñado para cultivar claridad y regulación interna.",
    features: ["Sesiones personalizadas", "Formato 1 a 1", "Virtual"],
